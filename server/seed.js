...
summaryEs: 'Tienda full stack con autenticación JWT, pasarela de pago y hardening OWASP (rate-limit, CSP, validación).',
summaryEn: 'Full‑stack store with JWT auth, payment gateway and OWASP hardening (rate‑limit, CSP, validation).',
tech: ['React','Node','Express','MongoDB','JWT'],
tags: ['fullstack','security'],
images: [],
links: { repo: 'https://github.com/tuuser/ecommerce', demo: '' },
securityHighlights: ['Validación de inputs','CSP','Rate limiting','Helmet'],
featured: true
},
{
title: 'Informe Pentesting Web',
slug: 'pentest-web-demo',
summaryEs: 'Evaluación de seguridad sobre app demo; hallazgos y remediaciones priorizadas.',
summaryEn: 'Security assessment on demo app; prioritized findings and remediations.',
tech: ['Burp','OWASP ZAP','Node'],
tags: ['security'],
links: { repo: '', demo: '' },
securityHighlights: ['XSS reflected','CSRF mitigations','TLS config review'],
featured: false
}
]);
